...
```csharp {title="ローカル変数があっても field はキーワード扱い" warning-ranges="7:17-7:22,8:20-8:25" warning-diagnostics="CS0219@7:17-7:22,CS9258@8:20-8:25"}
class A
{
    public int X
    {
...
```csharp {title="nameof(field) はダメ" error-text="field" error-diagnostics="CS8081@5:23-5:28" warning-text="X" warning-diagnostics="CS9264@3:19-3:20"}
class A
{
    public string X
    {
...
```csharp {title="タプル要素名とか、匿名型のプロパティとか" error-ranges="7:27-7:28,7:30-7:31,7:33-7:34" error-diagnostics="CS1002@7:27-7:28,CS1513@7:27-7:28,CS1026@7:27-7:28,CS1002@7:30-7:31,CS1513@7:30-7:31,CS1002@7:33-7:34,CS1513@7:33-7:34"}
class A
{
    public int X
    {
...
```csharp {title="??= で遅延初期化" warning-ranges="4:19-4:23" warning-diagnostics="CS9264@4:19-4:23"}
class A(Type type)
{
    // Type.Name のキャッシュ。
    public string Name
