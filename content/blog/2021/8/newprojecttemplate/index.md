...
```csharp {title="後ろに concat してる文字列"}
        }
    }
}
```
...
```csharp {title="C# 9.0 での「最初の C# プログラム」"}
using System;
...
```csharp {title="標準で自動生成される global using コード"}
// <autogenerated />
