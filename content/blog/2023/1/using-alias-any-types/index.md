...
```csharp {title="現状ではコンパイルできない using alias" error-ranges="1:20-1:23,2:15-2:18,2:19-2:20,3:18-3:22,4:15-4:19,4:21-4:24" error-diagnostics="CS1001@1:20-1:23,CS1001@2:15-2:18,CS1002@2:15-2:18,CS0116@2:19-2:20,CS1002@3:18-3:21,CS0116@3:21-3:22,CS1002@4:15-4:16,CS1525@4:16-4:19,CS1525@4:21-4:24"}
using Primitive =  int;
using Array = int[];
using Nullable = int?;
using Tuple = (int, int);
...
```csharp {title="トップレベルの NRT" error-ranges="2:11-2:18"}
