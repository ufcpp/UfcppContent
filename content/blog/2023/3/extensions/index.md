...
```csharp {title="プロパティに向かない文法、静的メンバーにも未対応" error-ranges="8:23-8:31,11:23-11:27,14:32-14:33" error-diagnostics="CS0548@8:23-8:31,CS0720@11:23-11:27,CS0548@11:23-11:27,CS0106@11:23-11:27,CS1534@14:32-14:33,CS0715@14:32-14:33,CS0161@14:32-14:33"}
...
```csharp {title="名前被りで解決できない拡張メソッド" error-ranges="4:3-4:9" error-diagnostics="CS0121@4:3-4:9"}
int x = 0;
...
```csharp {title="explicit exntension" highlight-ranges="10:1-10:9"}
...
```csharp {title="C# 11 で無理なものの、extension の実装に欲しいもの" error-ranges="2:16-2:32,5:5-5:10,5:11-5:16,8:20-8:28" error-diagnostics="CS0535@2:16-2:32,CS0535@2:16-2:32,CS8343@2:16-2:32,CS9050@5:5-5:10,CS0523@5:11-5:16,CS0306@8:20-8:28" warning-text="_refS" warning-diagnostics="CS0169@5:11-5:16"}
