...
```csharp {title="インターフェイス実装を消したらエラー" error-text="[1]" error-diagnostics="CS9174@5:7-5:10"}
...
```csharp {title="コレクション初期化子は使えるのに…" error-ranges="11:8-11:11" error-diagnostics="CS9215@11:8-11:11,CS1503@11:8-11:11"}
using System.Collections;
...
```csharp {title="コレクション初期化子は使えるのに… (再)" error-ranges="7:12-7:15" error-diagnostics="CS0029@7:12-7:15"}
using System.Collections;
...
```csharp {error-ranges="8:8-8:16" error-diagnostics="CS9215@8:8-8:16,CS1503@8:8-8:16"}
using System.Collections;
