...
```csharp {title="キーワードじゃないので…" error-ranges="9:17-9:23" error-diagnostics="CS0136@9:17-9:23" warning-ranges="9:17-9:23" warning-diagnostics="CS0219@9:17-9:23"}
class A
{
    public int X
    {
...
```csharp {title="nameof が使える" error-text="this" error-diagnostics="CS8081@11:29-11:33"}
class A
{
    public int X
    {
