...
```csharp {title="var" warning-ranges="5:7-5:10" warning-diagnostics="CS8981@5:7-5:10"}
// 普通は型推論の var になるはず。
var x = 1;
...
```csharp {title="_ (discard)" error-ranges="19:9-19:10" error-diagnostics="CS0128@19:9-19:10"}
