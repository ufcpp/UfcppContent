...
```csharp {title="Span をインターフェイス型変数に代入しちゃダメ" error-ranges="6:22-6:26" error-diagnostics="CS0029@6:22-6:26"}
...
```csharp {title="ジェネリクスを介すればいい" error-text="Sum&lt;int, Span&lt;int&gt;&gt;" error-diagnostics="CS0306@14:1-14:20"}
Span<int> span = [1, 2, 3, 4, 5];
...
```csharp {title="型制約" error-text="M2&lt;object&gt;" error-diagnostics="CS0311@19:1-19:11"}
// 制限なし。
static void M1<T>() { }
