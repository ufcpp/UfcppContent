...
```csharp {title="ref, out などが絡むと型名の省略ができない" error-ranges="11:21-11:22,12:19-12:20" error-diagnostics="CS1676@11:21-11:22,CS1676@12:19-12:20"}
...
```csharp {title="引数が多くて型の省略したい…" error-ranges="5:27-5:28,8:31-8:34,8:35-8:36" error-diagnostics="CS1676@5:27-5:28,CS0748@8:31-8:34,CS1676@8:35-8:36"}
// 全部の引数に型の明示が必要。
...
```csharp {title="型名が長くて省略したい…" error-ranges="5:23-5:24,8:27-8:30,8:31-8:32" error-diagnostics="CS1676@5:23-5:24,CS0748@8:27-8:30,CS1676@8:31-8:32"}
// 全部の引数に型の明示が必要。
...
```csharp {title="ref x, out x なら型名省略できてもいいのでは？" error-ranges="2:25-2:27,3:23-3:25,3:29-3:34,4:30-4:31,5:26-5:27" error-diagnostics="CS0246@2:25-2:26,CS1001@2:26-2:27,CS0246@3:23-3:24,CS1001@3:24-3:25,CS0177@3:29-3:34,CS0118@4:30-4:31,CS0118@5:26-5:27"}
...
```csharp {title="呼び出し元にも ref/out の明示が必須" error-ranges="12:21-12:22,13:19-13:20" error-diagnostics="CS1676@12:21-12:22,CS1676@13:19-13:20"}
RefAction<int> r = (ref int x) => { };
OutFunc<int> o = (out int x) => x = 1;
...
```csharp {title="ラムダ式引数の部分型指定は型推論が複雑になりそう" error-ranges="4:10-4:16,4:31-4:34" error-diagnostics="CS0411@4:10-4:16,CS0748@4:31-4:34" warning-ranges="3:22-3:28" warning-diagnostics="CS8321@3:22-3:28"}
// ラムダ式引数の部分型指定 + 型引数の推論。
// 結構推論機構が複雑になるはず。
...
```csharp {title="属性やデフォルト値が付いているときの型省略" error-ranges="8:37-8:38" error-diagnostics="CS9098@8:37-8:38" warning-ranges="4:23-4:55,8:24-8:49" warning-diagnostics="CS8622@4:23-4:55,CS9099@4:43-4:44,CS8625@4:47-4:51,CS8622@8:24-8:49"}
