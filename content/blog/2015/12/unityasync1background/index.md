---
title: "Unity上でasync/await: 背景"
source_url: "https://ufcpp.net/blog/2015/12/unityasync1background/"
content_type: "BlogEntry"
published_at: "2015-11-30T15:01:40"
updated_at: "2015-11-30T15:01:40"
tags: []
umbraco_id: 1826
parent_id: 1816
sort_order: 1
...
- 本家の[Rx](https://rx.codeplex.com/)が登場
...
![async/awaitが有効な非同期処理](../../../../../assets/media/1044/await1.png)

![Rxが有効な非同期処理](../../../../../assets/media/1045/await2.png)
...
詳しくは「[C#の言語バージョンと.NET Frameworkバージョン](../../../../study/csharp/cheatsheet/listfxlangversion.md)」で書いていますが、
ここで「2.0や3.0で動く」となっている機能は、コンパイラーさえバージョンアップすればUnity上でも使えます。

例えば、C# 6.0の新機能の大半は何もしなくても古いフレームワーク上で動きます。
Caller Info属性や、`FormattedString` は、簡単なクラスの自作で動かせます。
...
[導入文](../unityasync0introduction/index.md)でも書いていますが、あっさり動きすぎて、コミットが少なすぎて非アクティブに見える…
