...
```csharp {warning-ranges="8:33-8:41"}
#nullable enable
    // string には null が来ない
...
```csharp {warning-ranges="9:26-9:30"}
class Node
{
...
```csharp {warning-ranges="5:13-5:17"}
#nullable enable
...
```csharp {error-ranges="18:13-18:14"}
...
```csharp {warning-ranges="15:42-15:46,16:24-16:31,17:42-17:46"}
...
```csharp {error-ranges="16:12-16:14"}
