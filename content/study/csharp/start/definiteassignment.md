...
```csharp {title="未初期化変数を使おうとしてエラーになる例" error-ranges="4:19-4:20" error-diagnostics="CS0165@4:19-4:20"}
int x;
...
```csharp {title="if でだけ代入" error-ranges="12:23-12:24" error-diagnostics="CS0165@12:23-12:24"}
// ダメな例: if でだけ代入。
static void m(bool condition)
{
    int x;
...
```csharp {title="case に漏れ" error-ranges="15:23-15:24" error-diagnostics="CS0165@15:23-15:24"}
// ダメな例: case に漏れがあるとダメ。
static void m(byte condition)
{
    int x;
...
```csharp {title="通らないループ" error-ranges="11:19-11:20" error-diagnostics="CS0165@11:19-11:20" warning-ranges="7:5-7:6" warning-diagnostics="CS0162@7:5-7:6"}
// ダメな例: 通らないループ。
int x;
...
```csharp {title="早すぎる break" error-ranges="12:19-12:20" error-diagnostics="CS0165@12:19-12:20" warning-ranges="8:5-8:6" warning-diagnostics="CS0162@8:5-8:6"}
// ダメな例: 早すぎる break。
int x;
...
```csharp {title="永久ループ" warning-text="Console" warning-diagnostics="CS0162@11:1-11:8"}
// 大丈夫な例: 永久ループの下。
int x;
