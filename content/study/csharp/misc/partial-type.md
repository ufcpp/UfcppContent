...
```csharp {title="partial はすべての型定義に付ける必要あり" error-ranges="2:7-2:8" error-diagnostics="CS0260@2:7-2:8"}
...
```csharp {title="新旧・部分メソッド" highlight-ranges="30:5-30:12"}
// (1) ツールが事前に生成する想定のコード
...
```csharp {title="シグネチャが合わなくてエラーになる例" error-ranges="17:45-17:47,20:45-20:47,21:37-21:39,22:31-22:33,23:35-23:37" error-diagnostics="CS8817@17:45-17:47,CS8799@20:45-20:47,CS0763@21:37-21:39,CS8818@22:31-22:33,CS8818@23:35-23:37" warning-ranges="22:31-22:33,23:35-23:37" warning-diagnostics="CS8826@22:31-22:33,CS8826@23:35-23:37"}
partial class PartialClass
{
...
```csharp {title="タプル要素名が違うとエラー" error-ranges="14:35-14:37,15:35-15:37" error-diagnostics="CS8142@14:35-14:37,CS8142@15:35-15:37"}
partial class PartialClass
{
...
```csharp {title="引数名、nullability の差は警告に" warning-ranges="14:25-14:27,17:25-17:27" warning-diagnostics="CS8826@14:25-14:27,CS8611@17:25-17:27,CS8826@17:25-17:27"}
partial class PartialClass
{
...
```csharp {title="partial の get; set;" error-text="X" error-diagnostics="CS9248@4:24-4:25"}
partial class C
{
...
```csharp {title="実装がいない問題" error-ranges="4:24-4:25,11:24-11:25" error-diagnostics="CS9248@4:24-4:25,CS0102@11:24-11:25,CS9250@11:24-11:25"}
partial class C
{
    // 宣言。
    public partial int X { get; set; }
...
```csharp {title="partial には語順に制約がある" error-ranges="6:8-6:15,7:1-7:8,8:8-8:15,16:5-16:12"}
// OK
