...
```csharp {title="コレクション式と params コレクション利用時で結果がちょっと変わる珍しい例" error-ranges="sha256:0bc3d88090b2754578fcfdbf79b31222ecabbd6eb6d717f182580609e6595473;1:3-1:4"}
...
```csharp {title="params を付けた場合、暗黙的に scoped" error-ranges="sha256:ef8c071bd000e921daa10420157bc375117f7dc4b8a9d6dce33a2b333c7cafab;8:71-8:72,12:71-12:72"}
class A
{
