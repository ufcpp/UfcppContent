...
```csharp {title="要素の型からの型推論" error-text="new[] { 1, 2, 3 }" error-diagnostics="sha256:54661ecc894e5e866c60e118d1e382c82f497796bbb3ff1269f50a907966cb5d;CS0029@2:7-2:24"}
byte[] array // byte[] 型
...
```csharp {error-ranges="sha256:0c74d9f2fba93987ccc9702bc1465fdf547b81ec96a4d990e5cb9e5d3994c20f;3:9-3:10,3:12-3:13,3:15-3:16,3:19-3:20" error-diagnostics="sha256:0c74d9f2fba93987ccc9702bc1465fdf547b81ec96a4d990e5cb9e5d3994c20f;CS1525@3:9-3:10,CS1002@3:9-3:10,CS1513@3:12-3:13,CS1002@3:12-3:13,CS1513@3:15-3:16,CS1002@3:15-3:16,CS1002@3:19-3:20"}
int[] array; // 宣言
...
```csharp {title="配列とコレクションの切り替えが難しい" error-ranges="sha256:7229f46ce4422eb07d15a14172a336482bff54e73684877016903d5ce4dccc59;10:12-10:29" error-diagnostics="sha256:7229f46ce4422eb07d15a14172a336482bff54e73684877016903d5ce4dccc59;CS8752@10:12-10:29,CS1061@10:20-10:21,CS1061@10:23-10:24,CS1061@10:26-10:27"}
#if WPF
...
```csharp {title="参照型に対する stackalloc はエラーに" error-text="stackalloc[] { &quot;abc&quot; }" error-diagnostics="sha256:f389d70cd33adaa943d3ba450f6d0b23f28612258ab7c4ca7b7c0a727991020e;CS0208@1:21-1:43"}
...
```csharp {title="2つの {} 初期化子" error-ranges="sha256:137dc2646eb4854a5cfc94ca799a1962b13df5eef3241d0af6b5bb2906053ff0;2:46-2:47,2:49-2:50,2:52-2:53,14:5-14:13" error-diagnostics="sha256:137dc2646eb4854a5cfc94ca799a1962b13df5eef3241d0af6b5bb2906053ff0;CS0747@2:46-2:47,CS0747@2:49-2:50,CS0747@2:52-2:53,CS0747@14:5-14:13"}
...
```csharp {title="null があり得る foreach" warning-ranges="sha256:579eb1da8e5504cb97046c0fbe99198ad9964b57fc763d7e3b399d96936211bf;7:26-7:30" warning-diagnostics="sha256:579eb1da8e5504cb97046c0fbe99198ad9964b57fc763d7e3b399d96936211bf;CS8602@7:26-7:30"}
Print([1, 2, 3]);
Print(null);
...
```csharp {title="C# 12 時点では型決定できない var" error-text="[1, 2, 3]" error-diagnostics="sha256:286dd71c6edaf3fb6ad212fc1f713514f9070ace81cc17237c18c387e8206033;CS9176@1:12-1:21"}
var list = [1, 2, 3];
```
...
```csharp {title="具象型同士は同列" error-ranges="sha256:746b8274dccd464d4813f8ece3baa394d5a9da978b56ab1cf45ceca6ec76929e;1:3-1:4" error-diagnostics="sha256:746b8274dccd464d4813f8ece3baa394d5a9da978b56ab1cf45ceca6ec76929e;CS0121@1:3-1:4"}
A.M([]); // コンパイル エラー
...
```csharp {title="派生関係のないインターフェイスは同列" error-ranges="sha256:b15a7f3311e889be80f05978e3ff6198fd0dea1dd5ed611e3cf32f1fcbd440d8;1:3-1:4" error-diagnostics="sha256:b15a7f3311e889be80f05978e3ff6198fd0dea1dd5ed611e3cf32f1fcbd440d8;CS0121@1:3-1:4"}
A.M([]); // コンパイル エラー
...
```csharp {title="拡張メソッドからの型推論" error-ranges="sha256:773e05ae6a4eaab5c8d91a597de4c8741b630ece17098e8177fdb37ba6be5a7a;2:9-2:15" error-diagnostics="sha256:773e05ae6a4eaab5c8d91a597de4c8741b630ece17098e8177fdb37ba6be5a7a;CS9176@2:9-2:15"}
...
```csharp {title="非ジェネリック コレクション" error-text="[&quot;a&quot;, 2, null]" error-diagnostics="sha256:38c3a9a82b09cc9c3dd46f4dadcb1a88d6bf0db79065eb827cb2acd01d7edad6;CS9174@3:17-3:31"}
