...
```csharp {title="void の ?. 結果は void" error-text="x = Weapon1?.Dispose()"}
// void の ?. 結果は void。
...
```csharp {title="null を自称できる型の例" warning-ranges="sha256:02d928a43fa6c457cbf314560ca3492e6a1fba3950399686ee03cc95966dd9f3;19:26-19:27,20:26-20:27"}
...
```csharp {title="自称 null に対する挙動の差を示す例" warning-ranges="sha256:adf27164a0b4b82231bdd34af382a717606e4180a698a589de66f198313c84c3;15:29-15:30"}
