...
```csharp {title="引数なしコンストラクターの有無で new() の意味が変わる例" error-ranges="4:15-4:20"}
void m(
    NoCtor n1 = new(),
    NoCtor n2 = default,
...
```csharp {title="private、internal な引数なしコンストラクターはエラーになる" error-ranges="4:13-4:14,10:14-10:15"}
struct A
{
    public int X;
    private A() => X = 0; // エラー
...
```csharp {title="ref の語順の例" error-ranges="7:14-7:20,8:14-8:20,9:17-9:24,9:25-9:28,10:21-10:28,11:12-11:19,11:20-11:28"}
// OK
