...
```csharp {title="&amp; で関数ポインターを取れるのは静的メソッドのみ" error-ranges="7:27-7:37,10:27-10:43,13:27-13:37" error-diagnostics="CS8759@7:27-7:37,CS8759@10:27-10:43,CS8759@13:27-13:37"}
unsafe
{
    // 静的メソッドは OK。
